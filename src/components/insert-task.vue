<template>
	<div id="insert-task" class="scrollbar" style="height:100%;overflow:auto;position: relative;" >
		...
		<div class="scrollbarNone" style="top:42px;bottom:0;left:0;right:0;position:absolute;padding:0 10px 0 10px;overflow: auto;">
			<div style="height:10px;"></div>
			<div style="font-size: 14px;margin:0 0 0 0;color: #8f8f8f;">任务名</div>
			<div style="position: relative;height:30px;line-height: 30px;border:1px solid #8f8f8f;margin:5px 0 0 0;">
		...
		<div style="position: relative;height:30px;line-height: 30px;border:1px solid #8f8f8f;margin:5px 0 0 0;">
			...
			<div style="font-size: 14px;margin:10px 0 0 0;color: #8f8f8f;">类型</div>
			...
			<div style="font-size: 14px;margin:10px 0 0 0;color: #8f8f8f;">日常 ( 每天自动重发 )</div>
			<div style="margin:5px 0 0 0;">
			...
			<div style="font-size: 14px;margin:10px 0 0 0;color: #8f8f8f;">图片</div>
			<div v-viewer="{navbar:true,title:false,toolbar:true}" >
				...
				<span v-if="imageList.length<6" @click="addImage()" style="width:50px;height:50px;border:1px dashed #8f8f8f;display:inline-block;margin:5px 0 0 0;font-size: 14px;vertical-align: bottom;cursor: pointer;text-align: center;line-height: 50px;">+</span>
			</div>

			<div style="font-size: 14px;margin:10px 0 0 0;color: #8f8f8f;">内容</div>
			<div style="margin:5px 0 0 0;height:308px;position: relative;">
				<div style="position:absolute;left:0;right:0;">
					<textarea v-model="content" type="text" style="width:99%;padding:3px;border:1px solid #8f8f8f;height:300px;resize:none;" ></textarea>
				</div>
			</div>
